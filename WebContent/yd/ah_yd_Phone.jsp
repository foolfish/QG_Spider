...
display:none;
        			...
        			<c:set var="url" value="${putong_ah_yidong_url}"/>
        			<c:set var="result" value="putong_ah_yidong"/>
        			<form id="form1" class="base-form" action="">
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a class="base-forgetpwd" href="http://service.ah.10086.cn/operate/pwdModify/resetPwdIndex.action?kind=200011523" target="_blank">忘记密码</a>
						</div>
						<div style="padding-left: 120px">
...
$(document).ready(function(){
	getInitAuth("/${ctx}/yd/ah/first.html");
});
function getAuth(){
	getInitAuth("/${ctx}/yd/ah/image.html");
}
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/yd/ah/login.html';     //  -------------------------修改
...
function secondSubmit(){
	var mess = ${result}("message1");
	var vertifyUrl='/${ctx}/yd/ah/checkDynamics.html';
