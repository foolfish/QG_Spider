...
display:none;
        			...
        			<c:set var="url" value="${putong_cq_yidong_url}"/>
        			<c:set var="result" value="putong_cq_yidong"/>
        			<form id="form1" class="base-form" action="">
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a class="base-forgetpwd" href="http://service.cq.10086.cn/common/forgetpass.jsp?AISSO_LOGIN=true" target="_blank">忘记密码</a>
						</div>
						<div style="padding-left: 120px">
...
$(document).ready(function(){
	getInitAuth("/${ctx}/yd/cq/first.html");
});
function getAuth(){
	getInitAuth("/${ctx}/yd/cq/image.html");
}
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/yd/cq/login.html'+"?t="+new Date().getTime();
...
function secondSubmit(){
	var mess = ${result}("message1");
	var vertifyUrl='/${ctx}/yd/cq/checkDynamics.html';
