...
display:none;
        			...
        			<c:set var="url" value="${putong_zj_yidong_url}"/>
        			<c:set var="result" value="putong_zj_yidong"/>
        			<form id="form1" class="base-form" action="">
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a class="base-forgetpwd" href="http://service.zj.10086.cn/common/forgetpass.jsp?AISSO_LOGIN=true" target="_blank">忘记密码</a>
						</div>
						<div style="padding-left: 120px">
...
$(document).ready(function(){
	getInitAuth("/${ctx}/yd/zj/first.html");
});
function getAuth(){
	getInitAuth("/${ctx}/yd/zj/image.html");
}
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/yd/zj/login.html'+"?t="+new Date().getTime();
...
function secondSubmit(){
	var mess = ${result}("message1");
	var vertifyUrl='/${ctx}/yd/zj/checkDynamics.html';
