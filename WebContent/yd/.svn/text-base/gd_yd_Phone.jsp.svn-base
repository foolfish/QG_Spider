...
display:none;
        			...
        			<c:set var="url" value="${putong_gd_yidong_url}"/>
        			<c:set var="result" value="putong_gd_yidong"/>
        			<form id="form1" class="base-form" action="">
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a class="base-forgetpwd" href="https://gd.ac.10086.cn/ucs/login/signup.jsps" target="_blank">忘记密码</a>
						</div>
						<div style="padding-left: 120px">
...
$(document).ready(function(){
	getInitAuth("/${ctx}/yd/gd/first.html");
});
function getAuth(){
	getInitAuth("/${ctx}/yd/gd/image.html");
}
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/yd/gd/login.html';
...
function secondSubmit(){
	var mess = ${result}("message1");
	var vertifyUrl='/${ctx}/yd/gd/checkDynamics.html';
