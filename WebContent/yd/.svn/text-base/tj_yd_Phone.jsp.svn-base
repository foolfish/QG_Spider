...
display:none;
        			...
        			<c:set var="url" value="${putong_tj_yidong_url}"/>
...
$(document).ready(function(){
	getInitAuth("/${ctx}/yd/tj/first.html");
});
function getAuth(){
	getInitAuth("/${ctx}/yd/tj/image.html");
}
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/yd/tj/login.html?t='+new Date().getTime();
