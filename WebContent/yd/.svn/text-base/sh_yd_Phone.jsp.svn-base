...
display:none;
				...
				<c:set var="currentNet" value="上海移动"/>
					<c:set var="locationUrl" value="/${ctx}/yd/sh"/>
        			<c:set var="result" value="putong_sh_yidong"/>
        			<input type="hidden" name="isSecond" id="${result}isSecond"  value="0" />
        			<form id="form1" class="base-form" action="">
						<h2 class="base-form-title">上海移动：</h2>
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a href="https://sh.ac.10086.cn/login" target="_blank" class="base-forgetpwd">忘记密码</a>
							</div>
						<div style="padding-left: 120px">
