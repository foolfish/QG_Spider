...
display:none;
        			...
        			<c:set var="url" value="${putong_sx_yidong_url}"/>
        			<c:set var="result" value="putong_sx_yidong_url"/>
        			<form id="form1" class="base-form" action="">
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a class="base-forgetpwd" href="https://service.sn.10086.cn/app?service=page/personalinfo.ResetPwdOperation&listener=initPage" target="_blank">忘记密码</a>
						</div>
					   <div style="padding-left: 120px">
...
function getAuth(){
	...
	$.ajax({
	     ...
	     url:'/${ctx}/putong_sx_yidong_GetAuth.html',
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/putong_sx_yidong_vertifyLogin.html';
...
function getSms(){
	...
	$.ajax({
	     type:'post',
       async:false,
	     url:'/${ctx}/putong_sx_yidong_GetSms.html',
...
function secondSubmit(){
	var vertifyUrl='/${ctx}/dongtai_sx_yidong_vertifyLogin.html';
