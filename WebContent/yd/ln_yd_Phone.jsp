...
display:none;
        			...
        			<c:set var="url" value="${putong_ln_yidong_url}"/>
        			<c:set var="result" value="putong_ln_yidong_url"/>
        			<form id="form1" class="base-form" action="">
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a class="base-forgetpwd" href="http://www.ln.10086.cn/my/account/forgetpwd.xhtml" target="_blank">忘记密码</a>
						</div>
					   <div style="padding-left: 120px">
...
function getAuth(){
	...
	$.ajax({
         ...
         async:true,
         data:{userName:'${phone}'},
	     url:'/${ctx}/putong_ln_yidong_GetAuth.html',
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/putong_ln_yidong_vertifyLogin.html';
...
function getSms(){
	...
	$.ajax({
	     type:'post',
       async:false,
	     url:'/${ctx}/putong_ln_yidong_GetSms.html',
...
function secondSubmit(){
	var vertifyUrl='/${ctx}/dongtai_ln_yidong_vertifyLogin.html';
