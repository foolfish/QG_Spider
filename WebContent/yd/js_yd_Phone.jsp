...
display:none;
					...
					<c:set var="currentNet" value="江苏移动"/>
					<c:set var="locationUrl" value="/${ctx}/yd/js"/>
        			...
        			<form id="form1" class="base-form" action="">
						<h2 class="base-form-title">江苏移动：</h2>
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a class="base-forgetpwd" href="http://service.js.10086.cn/index.jsp#MMFW_MMCZ" target="_blank">忘记密码</a>
						</div>
						<div style="padding-left: 120px">
