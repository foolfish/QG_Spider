...
display:none;
        			...
        			<c:set var="url" value="${putong_hainan_dianxin_url}"/>
        			<c:set var="result" value="putong_hainan_dianxin_url"/>
...
function getAuth(){
	...
	$.ajax({
	     ...
	     url:'/${ctx}/putong_hainan_dianxin_GetAuth.html',
	     success : function(data) {
	    	 	var url = data.url;
	    	 	if(url != 'none'){				    	
	    	 		$("#authCodeDiv").show();
	    	 		$("#authcode_img").attr("src", "${imgPath}/img/icon_1.jpg");
	    	 		setTimeout(function(){
...
function firstSubmit(){
	...
	issubmit = true;
	var vertifyUrl='/${ctx}/putong_hainan_dianxin_vertifyLogin.html';
...
function getSms(){
	...
	$.ajax({
	     type:'post',
       async:false,
	     url:'/${ctx}/putong_hainan_dianxin_GetSms.html',
...
function secondSubmit(){
	...
	issubmit = true;
	var vertifyUrl='/${ctx}/dongtai_hainan_dianxin_vertifyLogin.html';
