...
display:none;
        			...
        			<c:set var="url" value="${putong_ln_dianxin_url}"/>
        			<c:set var="result" value="putong_ln_dianxin_url"/>
...
function getAuth(){
	...
	$.ajax({
         ...
         async:true,
         data:{userName:'${phone}'},
	     url:'/${ctx}/putong_ln_dianxin_GetAuth.html',
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/putong_ln_dianxin_vertifyLogin.html';
...
function getSms(){
	...
	$.ajax({
	     type:'post',
       async:false,
	     url:'/${ctx}/putong_ln_dianxin_GetSms.html',
...
function secondSubmit(){
	var vertifyUrl='/${ctx}/dongtai_ln_dianxin_vertifyLogin.html';
