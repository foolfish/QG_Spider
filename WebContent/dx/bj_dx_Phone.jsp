...
display:none;
				...
				<c:set var="currentNet" value="北京电信"/>
					<c:set var="locationUrl" value="/${ctx}/dx/bj"/>
        			<c:set var="result" value="putong_js_yidong"/>
        			<input type="hidden" name="isSecond" id="${result}isSecond"  value="0" />
        			<form id="form1" class="base-form" action="">
						<h2 class="base-form-title">北京电信：</h2>
						...
						<div class="base-fieldset login-fieldset clearfix">
							...
							<a class="base-forgetpwd" href="http://www.189.cn/dqmh/userCenter/pwdManage.do?method=restPwd&utype=uam" target="_blank">忘记密码</a>
						</div>
						<div style="padding-left: 120px">
...
function secondSubmit(){
	var mess = ${result}("message1");
	var vertifyUrl='${locationUrl}/checkDynamics.html';
