...
display:none;
        			...
        			<c:set var="url" value="${putong_gd_dianxin_url}"/>
        			<c:set var="result" value="putong_gd_dianxin"/>
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/putong_gd_dianxin_star.html';
	     ...
	     success : function(data) {
	    	 $("#message").hide();
			   if(data.flag=='1'){
					 ...
					 alert("登录失败,请重试.");
					 $("#putong_gd_dianxin_message").show();
					 //getAuth();
				 }
	    	},
	    	 error:function(){	    		
