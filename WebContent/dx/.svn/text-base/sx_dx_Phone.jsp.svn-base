...
display:none;
        			...
        			<c:set var="url" value="${putong_sx_dianxin_url}"/>
        			<c:set var="result" value="putong_sx_dianxin_url"/>
...
function getAuth(){
	...
	$.ajax({
	     ...
	     url:'/${ctx}/putong_sx_dianxin_GetAuth.html',
...
function firstSubmit(){
	var vertifyUrl='/${ctx}/putong_sx_dianxin_vertifyLogin.html';
...
function getSms(){
	...
	$.ajax({
	     type:'post',
       async:false,
	     url:'/${ctx}/putong_sx_dianxin_GetSms.html',
...
function secondSubmit(){
	var vertifyUrl='/${ctx}/dongtai_sx_dianxin_vertifyLogin.html';
