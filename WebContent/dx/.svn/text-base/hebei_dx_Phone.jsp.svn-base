...
display:none;
        			...
        			<c:set var="url" value="${putong_hebei_dianxin_url}"/>
        			<c:set var="result" value="putong_hebei_dianxin_url"/>
...
function getAuth(){
	...
	$.ajax({
	     ...
	     url:'/${ctx}/putong_hebei_dianxin_GetAuth.html',
...
function firstSubmit(){
	...
	issubmit = true;
	var vertifyUrl='/${ctx}/putong_hebei_dianxin_vertifyLogin.html';
...
function getSms(){
	...
	$.ajax({
	     type:'post',
       async:false,
	     url:'/${ctx}/putong_hebei_dianxin_GetSms.html',
...
function secondSubmit(){
	...
	issubmit = true;
	var vertifyUrl='/${ctx}/dongtai_hebei_dianxin_vertifyLogin.html';
