 ...
 * @date 2014-9-2
 */
public class GuangDongDianXinTest extends DianXinForSpiderTest {
	...
	protected void execute() {
		...
		//dx=new AnHuiDianXin(spider,null,phoneNo,password,"2345",null);
		dx = new GuangDongDianxin(spider, null, phoneNo, password,  null);		
		if (map == null && !isCache) {
			dx.setTest(true);
